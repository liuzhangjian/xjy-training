...
$config['asset'][] = array('file'=>'bep_login.css');
$config['asset'][] = array('file'=>'bep_icons.php','type'=>'css');
$config['asset'][] = array('file'=>'style.css');


//plugns css
$config['asset'][] = array('file'=>'redmond/ui.css','name'=>'ui');
$config['asset'][] = array('file'=>'dataTables.css');
$config['asset'][] = array('file'=>'autocomplete.css');
$config['asset'][] = array('file'=>'jqplot.css');
// BackendPro JS
$config['asset'][] = array('file'=>'jquery.js', 'name'=>'jquery');
$config['asset'][] = array('file'=>'jquery-ui.js', 'name' => 'jquery_ui', 'needs'=>'jquery|ui');
...
//plugns JS
$config['asset'][] = array('file'=>'jquery.dataTables.js', 'needs'=>'jquery|dataTables');
$config['asset'][] = array('file'=>'jquery.autocomplete.js', 'needs'=>'jquery|autocomplete');
$config['asset'][] = array('file'=>'jquery.colorize.js', 'needs'=>'jquery');
$config['asset'][] = array('file'=>'jquery.xheditor.js', 'needs'=>'jquery');
$config['asset'][] = array('file'=>'jquery.livequery.js', 'needs'=>'jquery');
$config['asset'][] = array('file'=>'jquery.ajaxfileupload.js', 'needs'=>'jquery');
$config['asset'][] = array('file'=>'jquery.json.js', 'needs'=>'jquery');

$config['asset'][] = array('file'=>'init.xheditor.js', 'needs'=>'jquery.xheditor');
$config['asset'][] = array('file'=>'init.dataTables.js', 'needs'=>'jquery.dataTables');
$config['asset'][] = array('file'=>'init.calendar.js', 'needs'=>'jquery_ui');
$config['asset'][] = array('file'=>'layout.js', 'needs'=>'jquery');

$config['asset'][] = array('file'=>'bep_admin.js', 'needs'=>'layout|jquery_ui|jquery.autocomplete|jquery.livequery|jquery.ajaxfileupload|jquery.json|init.dataTables|init.calendar|init.xheditor');

#$config['asset'][] = array('file'=>'front.js', 'needs'=>'jquery');
...
$config['asset_group']['PUBLIC'] = 'bep_login|FlashStatus';
$config['asset_group']['ADMIN'] = 'reset|typography|bep_admin_style|FlashStatus|forms|buttons|bep_navigation|treeview|bep_icons|bep_select_all|dataTables|bep_admin';

$config['asset_group']['FRONT'] = 'style|front';
...
/*
jquery plot
$config['asset_group']['JQPLOT'] = "jqplot|plot";
*/
