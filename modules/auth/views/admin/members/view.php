<div id="tbox">
	<div id="tbox_action"><?php echo anchor('auth/admin/members/form',$this->lang->line('userlib_create_user'),'class="icon_add"');?></div>
</div>
<div id="main">
<?php print form_open('auth/admin/members/delete')?>
<table class="display" id="nosort_dataTables">
    <thead>
        <tr>
